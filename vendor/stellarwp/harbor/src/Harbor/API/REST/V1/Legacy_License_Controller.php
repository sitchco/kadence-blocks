...
final class Legacy_License_Controller extends WP_REST_Controller {
	...
	public function get_item_schema(): array {
		...
		$this->schema = [
			...
			'properties' => [
				'key'        => [
					'description' => __( 'The license key.', 'kadence-blocks' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'slug'       => [
					'description' => __( 'The plugin slug.', 'kadence-blocks' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'name'       => [
					'description' => __( 'The plugin name.', 'kadence-blocks' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'product'    => [
					'description' => __( 'The product name.', 'kadence-blocks' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'is_active'  => [
					'description' => __( 'Whether the license is currently active.', 'kadence-blocks' ),
					'type'        => 'boolean',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'page_url'   => [
					'description' => __( 'The license management page URL.', 'kadence-blocks' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'expires_at' => [
					'description' => __( 'The license expiration date.', 'kadence-blocks' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
