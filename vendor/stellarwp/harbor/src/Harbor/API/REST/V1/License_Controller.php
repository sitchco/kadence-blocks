...
final class License_Controller extends WP_REST_Controller {
		...
		register_rest_route(
			...
			[
				[
					...
					'args'                => [
						'key' => [
							'description'       => __( 'The license key to look up.', 'kadence-blocks' ),
							'type'              => 'string',
							'required'          => true,
	...
	public function get_item_schema(): array {
		...
		$this->schema = [
			...
			'properties' => [
				'key'      => [
					'description' => __( 'The unified license key.', 'kadence-blocks' ),
					'type'        => [ 'string', 'null' ],
					'context'     => [ 'view' ],
				],
				'products' => [
					'description' => __( 'The products associated with the license key.', 'kadence-blocks' ),
					'type'        => 'array',
					'context'     => [ 'view' ],
					'items'       => [
						'type'       => 'object',
						'properties' => [
							'product_slug'      => [
								'description' => __( 'The product identifier.', 'kadence-blocks' ),
								'type'        => 'string',
							],
							'tier'              => [
								'description' => __( 'The entitlement tier.', 'kadence-blocks' ),
								'type'        => 'string',
							],
							'status'            => [
								'description' => __( 'The entitlement status.', 'kadence-blocks' ),
								'type'        => 'string',
							],
							'expires'           => [
								'description' => __( 'The expiration date.', 'kadence-blocks' ),
								'type'        => 'string',
								'format'      => 'date-time',
							],
							'activations'       => [
								'description' => __( 'Activation seat data.', 'kadence-blocks' ),
								'type'        => 'object',
								'properties'  => [
									'site_limit'   => [
										'description' => __( 'Maximum activation seats (0 = unlimited).', 'kadence-blocks' ),
										'type'        => 'integer',
									],
									'active_count' => [
										'description' => __( 'Current active activations.', 'kadence-blocks' ),
										'type'        => 'integer',
									],
									'over_limit'   => [
										'description' => __( 'Whether the seat limit is exceeded.', 'kadence-blocks' ),
										'type'        => 'boolean',
									],
									'domains'      => [
										'description' => __( 'Activated domain names.', 'kadence-blocks' ),
										'type'        => 'array',
										'items'       => [ 'type' => 'string' ],
									],
								],
							...
							'capabilities'      => [
								'description' => __( 'Feature slugs granted by this entitlement.', 'kadence-blocks' ),
								'type'        => 'array',
								'items'       => [ 'type' => 'string' ],
							],
							'activated_here'    => [
								'description' => __( 'Whether the product is activated on this domain.', 'kadence-blocks' ),
								'type'        => [ 'boolean', 'null' ],
							],
							'validation_status' => [
								'description' => __( 'The validation status for this product.', 'kadence-blocks' ),
								'type'        => [ 'string', 'null' ],
							],
							'is_valid'          => [
								'description' => __( 'Whether the product has a valid license.', 'kadence-blocks' ),
								'type'        => 'boolean',
							],
						],
					],
				...
				'error'    => [
					'description' => __( 'An error encountered while fetching the license, or null if none.', 'kadence-blocks' ),
					'type'        => [ 'object', 'null' ],
					'context'     => [ 'view' ],
					'properties'  => [
						'code'    => [
							'description' => __( 'The error code.', 'kadence-blocks' ),
							'type'        => 'string',
						],
						'message' => [
							'description' => __( 'The error message.', 'kadence-blocks' ),
							'type'        => 'string',
						],
					],
				],
	...
	private function get_store_args(): array {
		return array_merge(
			[
				'key' => [
					'description'       => __( 'The license key to store.', 'kadence-blocks' ),
					'type'              => 'string',
					'required'          => true,
	...
	private function get_network_args(): array {
		return [
			'network' => [
				'description' => __( 'Whether to operate on the network-level key (multisite only).', 'kadence-blocks' ),
				'type'        => 'boolean',
				'default'     => false,
			],
		];
