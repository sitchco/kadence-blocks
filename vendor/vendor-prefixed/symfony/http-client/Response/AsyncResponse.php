...
final class AsyncResponse implements ResponseInterface, StreamableInterface
{
        ...
        while ($responses) {
            ...
            foreach ($responses as $r) {
                if (!$r instanceof self) {
                    throw new \Kadence_Blocks_TypeError(sprintf('"%s::stream()" expects parameter 1 to be an iterable of AsyncResponse objects, "%s" given.', $class ?? static::class, get_debug_type($r)));
                }
    ...
    private function openBuffer(): ?\Kadence_Blocks_Throwable
    {
