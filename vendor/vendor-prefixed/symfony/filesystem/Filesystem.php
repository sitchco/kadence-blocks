...
class Filesystem
{
     ...
     *
     * @param string|iterable $files A filename, an array of files, or a \Kadence_Blocks_Traversable instance to check
     *
     * @return bool
     */
     ...
     *
     * @param string|iterable $files A filename, an array of files, or a \Kadence_Blocks_Traversable instance to create
     ...
     *
     * @param string|iterable $files A filename, an array of files, or a \Kadence_Blocks_Traversable instance to remove
     *
     * @throws IOException When removal fails
     */
    public function remove($files)
    {
        if ($files instanceof \Kadence_Blocks_Traversable) {
     ...
     *
     * @param string|iterable $files     A filename, an array of files, or a \Kadence_Blocks_Traversable instance to change mode
     ...
     *
     * @param string|iterable $files     A filename, an array of files, or a \Kadence_Blocks_Traversable instance to change owner
     ...
     *
     * @param string|iterable $files     A filename, an array of files, or a \Kadence_Blocks_Traversable instance to change group
     ...
     *
     * @param \Kadence_Blocks_Traversable|null $iterator Iterator that filters which files and directories to copy, if null a recursive iterator is created
     ...
     */
    public function mirror(string $originDir, string $targetDir, ?\Kadence_Blocks_Traversable $iterator = null, array $options = [])
    {
    ...
    {
        if (\is_array($content)) {
            throw new \Kadence_Blocks_TypeError(sprintf('Argument 2 passed to "%s()" must be string or resource, array given.', __METHOD__));
        }
