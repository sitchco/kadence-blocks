...
class ByteString extends AbstractString
{
    ...
    public function endsWith($suffix): bool
    {
        ...
        } elseif (\is_array($suffix) || $suffix instanceof \Kadence_Blocks_Traversable) {
    ...
    public function equalsTo($string): bool
    {
        ...
        } elseif (\is_array($string) || $string instanceof \Kadence_Blocks_Traversable) {
    ...
    public function indexOf($needle, int $offset = 0): ?int
    {
        ...
        } elseif (\is_array($needle) || $needle instanceof \Kadence_Blocks_Traversable) {
