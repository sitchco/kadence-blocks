...
class LineFormatter extends NormalizerFormatter
{
    ...
    protected function normalizeException(\Kadence_Blocks_Throwable $e, int $depth = 0): string
    {
    ...
    private function formatException(\Kadence_Blocks_Throwable $e): string
    {
    ...
    private function stacktracesParser(\Kadence_Blocks_Throwable $e): string
    {
