...
export const SPACING_SIZES_MAP = applyFilters(
	'kadence.constants.packages.components.column-drag-resizer.spacingSizesMap',
	[
		{
			value: '0',
...
export const PADDING_RESIZE_MAP = applyFilters(
	'kadence.constants.packages.components.column-drag-resizer.paddingResizeMap',
