...
export const SPACING_SIZES_MAP = applyFilters('kadence.constants.packages.helpers.constants.spacingSizesMap', [
	{
		value: 'ss-auto',
...
export const FONT_SIZES_MAP = applyFilters('kadence.constants.packages.helpers.constants.fontSizesMap', [
	{
		value: 'sm',
...
export const GAP_SIZES_MAP = applyFilters('kadence.constants.packages.helpers.constants.gapSizesMap', [
	{
		value: 'none',
