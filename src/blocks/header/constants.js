...
export const HEADER_INNERBLOCK_DEFAULTS = applyFilters(
	'kadence.constants.blocks.header.headerInnerblockDefaults',
	[
...
export const HEADER_ALLOWED_BLOCKS = applyFilters(
	'kadence.constants.blocks.header.headerAllowedBlocks',
	[
